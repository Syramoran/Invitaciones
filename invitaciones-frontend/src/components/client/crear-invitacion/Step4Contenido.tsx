...
function FotosSection({
  ...
  function handleFiles(files: FileList | null) {
    ...
    onChange({ fotos: newFiles, fotosPreviews: newPreviews })
  }
  ...
  return (
    <div className="bg-white border border-[#f0f0f0] rounded-xl p-4 mb-4">
      <h3 className="font-semibold text-[.9rem] mb-1">📷 Foto del anfitrión</h3>
      ...
      {fotos.length < 1 && (
        ...
        >
          ...
          <span className="text-[.82rem]">Arrastrá una foto acá o hacé click para subir</span>
          <span className="text-[.7rem] text-[#9ca3af] mt-0.5">JPG, PNG, WebP · Máx. 5 MB</span>
        </button>
      )}
    ...
    <div className="bg-white border border-[#f0f0f0] rounded-xl p-4 mb-4">
      ...
      {musica ? (
        ...
        <button type="button" onClick={() => inputRef.current?.click()}
          ...
          <span className="text-[.82rem]">Arrastrá un archivo MP3 o hacé click para subir</span>
