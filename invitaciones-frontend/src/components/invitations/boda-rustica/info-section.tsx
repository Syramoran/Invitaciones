...
export function InfoSection({ invitacion }: InfoSectionProps) {
  ...
  return (
    <section
      className="relative isolate flex flex-col items-center px-7 py-12 gap-6"
      style={{ fontFamily: "Quicksand, sans-serif" }}
    >
      <p className="text-base font-semibold text-[#787878]">Información</p>

      <div className="flex flex-col gap-6 pr-6 text-left">
        {/* Fecha */}
        <div className="flex items-start gap-4">
          <Calendar className="h-6 w-6 shrink-0 mt-0.5" style={iconStyle} />
          <div className="flex flex-col gap-1">
            <p className="text-base font-semibold" style={{ color: "var(--invitation-primary)" }}>
              Fecha
            </p>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <a
              ...
              className="mt-1 inline-block rounded-[1px] px-4 py-1.5 text-base font-semibold text-[#f1f1f0] transition-colors hover:opacity-80"
        ...
        {!esMultiple && (
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <p className="text-base font-semibold text-[#535353]">
                {direccion}
              </p>
            </div>
          </div>
