...
export function CountdownSection({ fechaEvento, horaEvento }: CountdownSectionProps) {
  ...
  return (
    <section
      className="flex flex-col items-start px-7 py-12 gap-6 text-center"
      style={{ fontFamily: "Quicksand, sans-serif" }}
    >
      <div className="self-stretch flex flex-col items-center">
        <p className="text-base font-semibold text-[#787878]">Faltan</p>
      </div>
      ...
      <div className="self-stretch flex items-center justify-center gap-3 flex-wrap">
        {boxes.map((box, i) => (
          <div key={box.unidad} className="flex items-center gap-3">
            <div className="h-[4.875rem] w-[4.375rem] flex flex-col items-center justify-center">
              <span
              ...
              <span className="mt-1 text-base font-semibold text-[#787878]">
                {box.unidad}
              </span>
            </div>
