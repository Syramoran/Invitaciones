  ...
  return (
    <div className="flex gap-2.5 flex-wrap">
      <a
        ...
        style={{ fontFamily: "'Nunito', sans-serif", backgroundColor: accentColor }}
      >
...
export function MapSection({ invitacion, accentColor }: MapSectionProps) {
  ...
  return (
    <section className="flex flex-col items-start px-7 pt-2 pb-6 gap-5">
      <p
      ...
      <div className="w-full">
        <p className="mb-1 text-base font-medium text-[#1a1a1a]" style={{ fontFamily: "'Nunito', sans-serif" }}>
          {ubicacion}
        </p>
        {direccion && (
          <p className="mb-3 text-base text-[#787878]" style={{ fontFamily: "'Nunito', sans-serif" }}>
            {direccion}
          </p>
        )}
