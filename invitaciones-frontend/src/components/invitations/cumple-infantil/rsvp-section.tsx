...
export function RsvpSection({ invitacionId, invitadoParam, mostrarBoton, accentColor }: RsvpSectionProps) {
  ...
  return (
    <section className="px-7 pb-6 pt-4 text-center">
      {estado === "success" ? (
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-[#777777]" style={{ fontFamily: "var(--font-infantil-body)" }}>
            {mensaje}
          </p>
        </div>
      ) : estado === "error" ? (
        <div className="flex flex-col items-center gap-4">
          ...
          <button
            ...
            style={{ color: accentColor, fontFamily: "var(--font-infantil-body)" }}
          >
            Intentar de nuevo
          </button>
        </div>
        ...
        <>
          <h2
            className="mb-4 text-[22px] text-[#1a1a1a]"
            style={{ fontFamily: "var(--font-infantil-display)", fontWeight: 400 }}
          >
            ¿Me acompañas?
          </h2>
          <button
            ...
            style={{
              ...
              fontFamily: "var(--font-infantil-body)",
            }}
          >
            {estado === "loading" ? (
              <>
