      ...
      <div className="flex flex-col gap-6 w-full pr-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-base text-[#787878]" style={{ fontFamily: "'Raleway', sans-serif" }}>
              Fecha
            </p>
            <p className="text-[17px] font-medium text-[#1a1a1a]" style={{ fontFamily: "'Raleway', sans-serif" }}>
